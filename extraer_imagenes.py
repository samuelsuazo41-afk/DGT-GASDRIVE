...
def extraer_pdf(pdf_path, output_folder, codigos):
    ...
    for page_num in range(len(doc)):
        ...
        for img_index, img in enumerate(images):
            ...
            try:
                ...
                # Para web forzamos PNG, mejor calidad y compatibilidad
                ...
                print(f"[{img_count + 1}/{len(codigos)}] Guardada: {filename} - Pág {page_num + 1}")
                img_count += 1
                codigo_index += 1
...
PDFS = [
    {
        ...
        "codigos": [
            ...
            # INDICACIONES S-50 a S-63, S-100 a S-126
    ...
    },
    {
        ...
        "codigos": [
            "etiqueta-b", # Pág 16 - Adhesivo amarillo
            "etiqueta-c", # Pág 17 - Adhesivo verde
            "etiqueta-eco", # Pág 18 - Adhesivo verde-azul
            "etiqueta-0", # Pág 19 - Adhesivo azul
            "senal-r118-zbe", # Pág 26 - Señal R-118 Zona Bajas Emisiones
            "colocacion-etiqueta", # Pág 22 - Parabrisas etiqueta abajo derecha
            "tabla-euro" # Pág 20 - Tabla Euro normas B/C/ECO/0
        ]
    }
]
# ==========================================
...
if __name__ == "__main__":
    ...
    for config in PDFS:
        if os.path.exists(config["pdf"]):
            total += extraer_pdf(config["pdf"], config["folder"], config["codigos"])
        else:
